    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        if(id.equals("") && slipNo.equals("")){
            ...
            try{
                ...
                String secName = s.getSectionName(rs.getInt("sectionId"));
                
                Month m = new Month();
                String month = m.getMonthName(rs.getInt("month"));
                
                String field = rs.getInt("field") == 0 ? "Engineering" : "Medical";
                
                textField2.setText(id);
                textField3.setText(slipNo);
                textField4.setText(rs.getString("std_name"));
                textField5.setText(secName);
                textField6.setText(month);
                textField7.setText(rs.getString("fees"));
                textField8.setText(rs.getString("std_name"));
                textField9.setText(rs.getString("std_name"));
